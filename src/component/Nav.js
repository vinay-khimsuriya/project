...
const Nav = () => {
  ...
  return (
    <div className="w-full sticky top-0 z-50">
      <nav className="w-full bg-black flex flex-col items-center justify-center relative">
                ...
                {navOption.map((option, index) => (
                  ...
                  >
                    ...
                    <div
                      ...
                      w-full hidden -z-10 custom:flex justify-center transition-all duration-1000 absolute left-0 bg-black text-white cursor-default`}
                    >
